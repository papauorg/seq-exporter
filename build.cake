...
const string SOLUTION_FILE = "./seq-exporter.sln";
...
Task("Package")
    ...
    .Does(() => {
        ...
        DotNetPublish("./src/seq-exporter/seq-exporter.csproj", nugetPackageBuildSettings);

        Zip("./artifacts/win/", $"./artifacts/seq-exporter.{versionInfo.SemVer}.zip");
    });
